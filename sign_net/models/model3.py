...
from layers import EGNNLayer, RegressionLayer, SignNetLayer, SignNetLayer_Transformer, SignNetLayer_Transformer2
from utils import *
...
class DrugNet_3(nn.Module):
    def __init__(self, pos_enc_dim, node_dim, hidden_dim, out_dim, edge_dim, rbf_dim):
        super().__init__()
        self.sign_net = SignNetLayer_Transformer2(pos_enc_dim, hidden_dim, out_dim, edge_dim)
